---
title: "wordclouds for Anne Hardenberg"
...
```{r}
#Follows the guide from software carpentry 
list.files(path = "data:breve_hardenberg", pattern = "brev_hardenberg", full.names = TRUE)
```
```{r}
#Follows the guide from software carpentry 
filenames <- list.files(path = "data:breve_hardenberg",  
                        pattern = "brev_hardenberg-[0-7]{2}.pdf",
                        full.names = TRUE)
for (f in filenames) {
  print(f)
  analyze(f)
...
file_years <- c(   
  "brev_hardenberg-01.pdf" = "Letter 1: 1564-03-30",
  "brev_hardenberg-02.pdf" = "Letter 2: 1565-09-19",
  "brev_hardenberg-03.pdf" ="Letter 3: 1571_10_15",
  "brev_hardenberg-04.pdf" = "Letter 4: 1572-01-31",
  "brev_hardenberg-05.pdf" = "Letter 5: 1573-03",
  "brev_hardenberg-06.pdf" = "Letter 6: 1573/1574",
  "brev_hardenberg-07.pdf" = "Letter 7: 1574-03"
  )
...
all_words_tf_idf %>%
  ...
  labs(
    title = "Anne Hardenbergs letters: most unique words per year",
...
```{r}
ggsave("wordcloudAnneHardenberg.png", width = 20, height = 10,  units = "cm", bg = "white")
```
