...
I expect words as "war" and "dragon" to be frequent. I also expect that the sentiment analysis will show, that there are more words associated with negative feelings than positive. 
...
The word "lord" is ambiguous, as it applies to four sentiments: disgust, negative, positive and trust. This tells me that they probably adress someone as lord with very different sentiment, both positive and negative, which makes sense.  
